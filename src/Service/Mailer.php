...
class Mailer
{
     ...
     * @throws \Throwable
     */
    public function sendEmailMessage(User $user)
    {
        $context = [
            'success' => 'Register success'
        ];

        $this->sendMessage('security/email/register-done.html.twig', $context, $this->noreply, $user->getEmail());
    }
    ...
    public function sendResetPasswordEmailMessage(User $user)
    {
        ...
        $this->sendMessage('security/email/request-password.html.twig', $context, $this->noreply, $user->getEmail());
    }
